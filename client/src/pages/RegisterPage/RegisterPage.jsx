...
export const RegisterPage = () => {
	...
	return (
		<div className="register-container m-auto rounded-xl">
			<form onSubmit={handleSubmit(onSubmit)}>
				<AiOutlineClose className="absolute text-sm" />
				<h5 className="text-center font-bold mb-3">Đăng ký</h5>
				<hr></hr>
				<p className="font-bold mt-3">
					Chào mừng đến với <span className="primary-color">Antidee</span>
				</p>
				...
				<button
					type="submit"
					className="block register-btn text-white text-center rounded-md p-1 font-medium mb-1"
				>
					<p>Đăng ký</p>
				</button>
				<Link>
					<p className="text-right small-text font-medium mb-5">
						Đã có tài khoản? <Link to={'/login'}><span className='small-text primary-color'>Đăng nhập</span></Link> ở đây
					</p>
				</Link>
