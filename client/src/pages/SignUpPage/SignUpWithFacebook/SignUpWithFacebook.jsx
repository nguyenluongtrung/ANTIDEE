...
const SignUpWithFacebook = ({ roleSignUp, facebookAccount }) => {
    ...
    const [email, setEmail] = useState(facebookAccount.email)
    const [fullName, setFullName] = useState(facebookAccount.displayName)
    ...
    //Submit bằng Facebook
    const onSubmitCreateAccountWithFacebook = async () => {
    ...
    const handleCheckGoogle = (e) => {
        e.preventDefault();
        onSubmitCreateAccountWithFacebook()
    }
            ...
            <div className="select-none">
                <form onSubmit={handleCheckGoogle}>
                    ...
                    {/* <div className="flex flex-col items-center justify-center mb-8">
                        ...
                        <img src={facebookAccount.photoURL} className="w-28 h-auto object-cover" />
                    </div> */}
                    ...
                    <input
                        ...
                        value={facebookAccount.phoneNumber}
