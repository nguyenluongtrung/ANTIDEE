...
export const ForumDiscussions = () => {
  ...
  const handleUpdateCommentLocal = (forumPostId) => {
    setForumPost((prevPosts) => {
	  ...
	  console.log(updatedPost[foundPostIndex].comments)
	  return prevPosts;
    });
  };
        ...
        <div className="">
          ...
          <div className={`relative flex flex-col rounded-lg shadow-lg p-4`}>
            <div className="flex justify-around">
              ...
              <div
                className=" w-[85%] rounded-full border border-gray flex items-center px-4 font-medium text-gray cursor-pointer hover:bg-[#F6F6F6]"
        ...
        {forumPost?.map((post) => {
          return (
            <DetailedForumPost
			  ...
			  handleUpdateCommentLocal={()=>handleUpdateCommentLocal(post._id)}
