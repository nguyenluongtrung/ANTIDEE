...
export const DetailedRepository = ({ selectedForumRepository, onClose, onOpenTopDiscussionDetail }) => {
	return (
		<div className="popup active">
			...
			<div className="content rounded-md p-5 w-[40vw] max-h-[80%] overflow-y-auto">
				...
				{selectedForumRepository?.postsList.map((post) => {
					return (
						<div className="">
							...
							<div
								...
								onClick={() =>
									onOpenTopDiscussionDetail(post?.postId._id)
								}
							>
