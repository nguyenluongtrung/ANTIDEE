					...
					<div className="justify-center  bg-primary rounded p-2">
						<div className="grid grid-cols-4 gap-4 items-center ">
							<div className="col-span-3">
								<strong className="flex items-center text-white text-xl">
									<BiSolidCommentError size={30} className="text-white mr-2" /> Bị ẩn
								</strong>
								<p className="text-white">Nhờ hoạt động báo cáo, chúng tôi có thể xử lý nội dung không mong muốn.</p>
							</div>
							<button
						...
						<div className="text-white ">
							<strong className="flex">
								...
								Đã ẩn bài viết của {post?.author?.name}</strong>
											...
											{isOpenReport && (
												<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 ">
													<div className="bg-white p-4 rounded-lg shadow-lg max-w-sm w-full">
														...
														/>
														<h1 className="text-2xl font-bold text-center">Báo cáo</h1>
														<div>
															<strong className="text-xl">Tại sao bạn báo cáo bài viết này?</strong>
															<p className="text-justify text-sm">
																Hãy cho quản trị viên biết bài viết này có vấn đề gì. Chúng tôi sẽ
																không thông báo cho người đăng rằng bạn đã báo cáo bài viết.
															</p>
														</div>
														<div>
