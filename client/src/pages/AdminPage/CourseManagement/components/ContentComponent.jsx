...
const ContentComponent = ({ content, lessonIndex, contentIndex, setFormData, formData, listExams }) => {
    ...
    return (
        <div className="rounded mt-2">
            {/* {console.log("xem list được filter chưa?: ", filterListExams())} */}
                ...
                {content.contentType === 'Exam' && (
                    <div className="flex flex-col w-full">
                        <select
                            ...
                            className="border rounded !max-w-[240px] w-[240px]"
                        >
