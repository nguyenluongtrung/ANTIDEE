...
export const CreateService = ({ setIsOpenCreateService, handleGetAllServices }) => {
	...
	const onSubmit = async (data) => {
		...
		const serviceData = 
			serviceUrl !== '' 
				? { ...trimmedData, image: serviceUrl } 
				: { ...trimmedData, image: 'https://static8.depositphotos.com/1010338/959/i/450/depositphotos_9597931-stock-photo-team-gear-3d-isolated-characters.jpg' };
