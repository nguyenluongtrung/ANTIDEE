...
import { createPromotion, getAllPromotions } from '../../../../features/promotions/promotionSlice';
...
export const CreatePromotion = ({ setIsOpenCreatePromotion, handleGetAllPromotions }) => {
    const { isLoading: promotionLoading, promotions } = useSelector((state) => state.promotions);
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input
                                    type="text"
                                    {...register('promotionName', { required: 'Tên mã giảm giá là bắt buộc' })}
