...
export const JobPostListPage = () => {
	...
	return (
		<div className="px-16">
			{isOpenJobPostDetail && <JobPostDetail chosenJobPostId={chosenJobPostId} handleGetAllJobPosts={handleGetAllJobPosts} setIsOpenJobPostDetail={setIsOpenJobPostDetail}/>}
						...
						<div className="shadow-xl p-7 hover:shadow-2xl hover:cursor-pointer">
							...
							<p className="text-gray mb-2">
								...
								<span className="text-brown">
									{formatDate(post?.startingTime)}{' '}
									{formatTime(post?.startingTime)}
								</span>
							</p>
