...
export const WannaBecomeHelperPage = () => {
    return (
        <div className='p-10 md:p-0 md:pb-10'>
            ...
            <div className="md:flex justify-around items-center w-full px-52 hidden">
            ...
            <div className='flex flex-col md:flex-row justify-between items-center md:px-20'>
                <div className='shadow-md rounded-2xl p-8 md:w-[30%] md:h-[440px]' >
                    ...
                    <div className='grid justify-center h-2 m-0 mt-3'>
                        <Link className='bg-green text-center text-white w-28 p-1 rounded-full hover:bg-primary' to={'/qualifications'}>Vào thi</Link>
                    </div>
                </div>

                <img className='w-32 mt-10 rotate-45 hidden md:block' src={arrow} />
                ...
                <div className='shadow-md rounded-2xl p-8 md:w-[30%] md:h-[440px]'>
                    ...
                    <div className='grid justify-center mt-3'>
                        <Link className='bg-green text-center text-white w-28 p-1 rounded-full hover:bg-primary' to={'/courses'}>Vào học</Link>
                    </div>
                </div>

                <img className='w-32 mt-10 transform scale-y-[-1] rotate-[315deg] hidden md:block' src={arrow} />
                ...
                <div className='shadow-md rounded-2xl p-8 md:w-[30%] md:h-[440px]'>
                    ...
                    <div className='grid justify-center'>
                        <Link className='bg-green flex text-center text-white w-28 mt-3 p-1 rounded-full hover:bg-primary' to={'/update-profile'}><p className='pl-5 !text-center'>Cập nhật</p></Link>
                    </div>
                </div>
            </div>
        </div>
