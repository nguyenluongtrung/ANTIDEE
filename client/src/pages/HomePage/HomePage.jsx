						...
						{/* <div className="mt-[110px]">
							...
							<div className="flex wrapper">
								{services.map((service, index) => (
									...
									<div className={`service service${index}`}>
										<div
											key={index}
											className=" mx-4 transition duration-300
								 						ease-in-out transform hover:scale-110
								 							 border-gray shadow-2xl rounded-[15px] 
								 								 hover:cursor-pointer"
										>
											<div className="p-4 size-64">
												<p
												...
												<img
													src={service?.image}
													alt={service?.name}
													className="w-[225px] h-[185px] object-cover rounded-lg "
