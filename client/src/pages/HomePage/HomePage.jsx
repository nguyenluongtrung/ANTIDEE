      ...
      <div className="mt-20">
        ...
        <div className="flex justify-center grid-cols-2 lg:grid-cols-4 lg:gap-[30px]">
          {achievement.map((item, index) => {
            return (
              <div
                className="container flex bg-white flex-col justify-center items-center gap-y-2 bg-slate-50 max-w-[292px] h-[220px] m-3 rounded-md shadow-md"
                data-aos="fade-left"
                data-aos-offset="400"
          ...
          <div className=" flex flex-col gap-y-4 justify-center w-1/2 mx-12">
            <div className="flex flex-col pr-5 gap-y-4 justify-center">
              ...
              <PiArrowBendDownRightBold
                size={60}
                className="absolute -bottom-3 left-24 animate-bounce"
              />
