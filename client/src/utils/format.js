...
export const formatDateMessage = (dateString) => {
  ...
  if (
    ...
    return `Hôm nay, ${date.toLocaleTimeString("vi-VN", timeOptions)}`;
  }
  ...
  if (
    ...
    return `Hôm qua, ${date.toLocaleTimeString("vi-VN", timeOptions)}`;
  }

  return date.toLocaleString("vi-VN", dateOptions).replace("lúc","");;
};