...
export const Sidebar = ({ sidebarVisible, setSidebarVisible, services, account, isServicesOpen, setIsServicesOpen }) => {
	...
	return (
		<div className="relative h-full">
			{/* Sidebar */}
			<div
				className={`fixed top-0 left-0 h-full w-64 bg-white text-black shadow-2xl z-40 transform transition-transform duration-300 ease-in-out ${
